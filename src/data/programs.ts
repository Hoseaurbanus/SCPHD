...
export const programs: Program[] = [
  ...
  {
    id: 'tangale-cultural-heritage',
    title: 'Restoration, Preservation, and Protection of Tangale Culture and Heritage',
    subtitle: 'Safeguarding the Tangale People\u2019s Language, Festivals & Historical Identity',
    status: 'completed',
    year: 2024,
    date: '2023\u20132024',
    location: 'Gombe State, Nigeria (Ture, Kwame, Billiri, Kaltungo, Shongom)',
    partner: 'Heritage Management Organization',
    partners: ['Heritage Management Organization', 'Mellon Foundation'],
    type: 'Cultural Heritage Preservation',
    summary:
      'A Mellon Foundation-funded initiative implemented in partnership with the Heritage Management Organization to restore, preserve and protect the cultural heritage of the Tangale people of Gombe State. The project documented and promoted their native language, culinary traditions, festivals, religious diversity and settlement history\u2014tracing their origins from Yemen through Egypt.',
    activities: [
      'Language Documentation & Promotion',
      'Culinary Heritage Preservation',
      'Festival Documentation & Support',
      'Religious Diversity Education',
      'Settlement History Research',
      'Community Empowerment',
    ],
    fullReport: [
      'The Tangale Cultural Heritage project, supported by the Mellon Foundation and implemented through a partnership between SCPHD and the Heritage Management Organization, ran from 2023 to 2024 in Gombe State, Nigeria.',
      'The project was designed to restore, preserve and protect the cultural heritage of the Tangale people, whose native language is spoken in the communities of Ture, Kwame, Billiri, Kaltungo and Shongom.',
      'The project documented the Tangale people\u2019s unique culinary traditions, preparing traditional dishes with local ingredients and promoting these delicacies as a vital part of their cultural identity.',
      'The project also supported local festivals, which play a central role in the community\u2019s cultural life, while fostering understanding and respect for the religious diversity that characterises Tangale society.',
      'A significant component of the project involved research into the history of the Tangale settlement, tracing their origins from Yemen through Egypt to their current home in Gombe State, thereby strengthening the community\u2019s sense of historical memory and identity.',
      'The outcomes included the preservation of the Tangale people\u2019s language, culinary traditions, cultural identity, religious diversity, historical memory, and cultural sites. The project empowered and educated community members while enhancing and diversifying the community\u2019s social and economic activities.',
    ],
  },
]
