    ...
    <div className={cn('flex flex-col h-full', className)}>
      <div className="p-4 border-b border-navy-800">
        <Link to="/" className="flex items-center gap-3">
          <img src="/images/favicon/Logo.jpg" alt="Springfield Centre" className="w-9 h-9 object-contain flex-shrink-0" />
          {!collapsed && (
            <div>
              <span className="text-white font-bold text-sm">Springfield Centre</span>
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <button className="p-2 text-white/50 hover:text-white rounded-sm hover:bg-navy-800 transition-colors relative">
                  ...
                  <span id="notification-count" className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-red-500 rounded-full text-[9px] text-white items-center justify-center font-bold hidden">
                    0
                  </span>
                </button>
              </div>
